...
namespace monoplatformer
{
    ...
    {
        //Physical structures of the level
        private Tile[,] tiles;
        ...
        public Level(IServiceProvider serviceProvider, Stream fileStream, int levelIndex)
        {
            ...
            layers[1] = new Layer(Content, "Backgrounds/Layer0", 0.5f);
        ...
        private Tile LoadTile(string name, TileCollision collision)
        {
            ...
            return new Tile(Content.Load<Texture2D>("Tiles/BlockA0"), collision);
        }
        ...
        /// impossible to escape past the left or right edges.
        /// </summary>
        public TileCollision GetCollision(int x, int y)
        {
            ...
            // Prevent jumping past the level top and falling through the bottom.
            if (y < 0 || y >= Height)
                return TileCollision.Impassable;
            ...
            MouseState mouseState)
        {
            ...
            else
            {
                ...
                Player.Update(gameTime, keyboardState, gamePadState, orientation, mouseState);
                UpdateGems(gameTime);
        ...
        public void Draw(GameTime gameTime, SpriteBatch _spriteBatch)
        {
            ...
            for (int i = 0; i <= EntityLayer; ++i)
                layers[i].Draw(_spriteBatch, cameraPosition);
            _spriteBatch.End();

            ScrollCamera(_spriteBatch.GraphicsDevice.Viewport);
